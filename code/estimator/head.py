...
# ==============================================================================
"""Abstractions for the head(s) of a model.py."""
...
class _Head(object):
  """Interface for the head/top of a model.py.
  ...
  Common usage:
  Here is simplified model_fn to build a DNN regression model.py.
    ```python
  ...
  def create_estimator_spec(
    ...
    Args:
      ...
      train_op_fn: Function that takes a scalar loss `Tensor` and returns an op
        to optimize the model.py with the loss in TRAIN mode. Used if `optimizer`
  ...
  def _create_tpu_estimator_spec(
    ...
    """
    raise NotImplementedError(
        'TPUEstimatorSpec not available for this model.py head.')
...
def _accuracy_baseline(labels_mean):
  ...
  This is the best the model.py could do by always predicting one class.
...
class _BinaryLogisticHeadWithSigmoidCrossEntropyLoss(_Head):
  ...
  def create_loss(self, features, mode, logits, labels):
    ...
    logits_list = list(map(ops.convert_to_tensor, logits_list))
